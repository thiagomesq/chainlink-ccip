...
contract MessageSender is Ownable {
    ...
    function sendMessage(uint64 destinationChainSelector, address receiver)
        external
        onlyOwner
        returns (bytes32 messageId)
    {
        string memory message = "Hey there!"; // The message to be sent.
        ...
        emit MessageSent(messageId, destinationChainSelector, receiver, message, address(s_linkToken), fees);
